...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sistemas sob medida, automação de processos e agentes de IA autônoma." },
      { property: "og:title", content: "GB IA — Sistemas, automação e IA autônoma" },
      { property: "og:description", content: "Sistemas sob medida, automação de processos e agentes de IA autônoma." },
